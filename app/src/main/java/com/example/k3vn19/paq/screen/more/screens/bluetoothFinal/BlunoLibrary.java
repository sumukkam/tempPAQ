...
public abstract class BlunoLibrary {
    ...
    /**
     * To display the list of bluetooth devices
     */
	...
	public BlunoLibrary(Context appContext) {
	...
	static AlertDialog mScanDeviceDialog;
    ...
    public void onCreateProcess() {
		...
		mScanDeviceDialog = new AlertDialog.Builder(mainContext).setTitle("BLE Device Scan...").setAdapter(mLeDeviceListAdapter, new DialogInterface.OnClickListener() {
    ...
    public void onResumeProcess() {
		...
		if (!mBluetoothAdapter.isEnabled()) {
			if (!mBluetoothAdapter.isEnabled()) {
				System.out.println("*%^&%^*onResumeProcess inner if");
...
//            mHandler.postDelayed(mDisonnectingOverTimeRunnable, 10000);
    ...
    public void buttonScanOnClickProcess() {
    	...
    	System.out.println("connection state: " + mConnectionState);
